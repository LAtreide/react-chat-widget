...
function Messages({ profileAvatar, profileClientAvatar, showTimeStamp, autoScroll }: Props) {
  ...
  useEffect(() => {
    // @ts-ignore
    if(autoScroll) scrollToBottom(messageRef.current);
  ...
  }, [messages, badgeCount, showChat, autoScroll]);
